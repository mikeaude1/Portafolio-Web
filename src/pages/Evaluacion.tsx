      ...
      <div className="project-container">
        ...
        <ol>
          <li>
            ...
            <p>
              El usuario encargado del área puede publicar los formularios de evaluación una vez que las preguntas estén agregadas, presionando el botón para activar las preguntas deseadas y manteniendo el orden de creación.
            </p>
            ...
            <ul>
              <li style={{ listStyleType: 'none' }}>
                ...
                <p>Visualización de Resultados: Los resultados del análisis de datos se presentan de manera clara y comprensible a través de gráficos, tablas y visualizaciones interactivas.</p>
          ...
          <li>
            ...
            <p>
              Cuando la empresa accede a la sección de encuestas pendientes, verá una lista de todas las encuestas publicadas por el usuario encargado del área.
            </p>
            <p>
        ...
        <div className="conclucion">
          ...
          <p>Tecnologías y modelo aplicados:</p>
          <ul>
